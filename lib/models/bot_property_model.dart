class BotProperty {
  ...
  BotProperty({this.key, this.type, this.description, this.needed, this.nullable, this.defaultValue, this.acceptedValues});
...
class BotPropertyList {
  ...
  BotPropertyList({this.botProperties});

  factory BotPropertyList.fromJson(Map<String, dynamic> json) {
    return BotPropertyList(botProperties: (json["bot_properties"] as List).map((i) => BotProperty.fromJson(i)).toList());
  }
}
