...
class AppTextStyles {
  ...
  static const TextStyle gameCardName = const TextStyle(fontSize: 22.0, color: AppColors.blackColor);
  static const TextStyle gameCardBots = const TextStyle(fontSize: 16.0, color: AppColors.blackColor);
}
